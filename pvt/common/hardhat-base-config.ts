...
const contractSettings: ContractSettings = {
  ...
  '@verified-network/pool-secondary-issues/contracts/SecondaryIssuePoolFactory.sol': {
    version: '0.7.1',
    runs: 200,
  },
  '@verified-network/pool-margin-trading/contracts/MarginTradingPoolFactory.sol': {
    version: '0.7.1',
    runs: 200,
  },
};
